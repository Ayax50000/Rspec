...
describe 'SecondGrade' do
  ...
  it "d is equal 0"do
    ...
    ecuation.solve
    ecuation.d_equal_0
    expect(ecuation.x1).to eql(-1)
    expect(ecuation.x2).to eql(-1)
  end
  ...
  it "d is mayor than 0" do
    ...
    ecuation.solve
    ecuation.d_major_0
    expect(ecuation.x1).to eql(1.0)
    expect(ecuation.x2).to eql(-0.5333333333333333)
  end
  ...
  it "d is minor than 0" do
    ...
    ecuation.solve
    ecuation.d_minor_0
    expect(ecuation.x1).to eql(0.027402333828162595)
    expect(ecuation.x2).to eql(-2.027402333828163)
  end
